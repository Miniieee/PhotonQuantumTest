...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct CooldwonState {
  ...
  public unsafe partial struct ShrinkState {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 14083;
        hash = hash * 31 + ShrinkingTime.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (ShrinkState*)ptr;
        FP.Serialize(&p->ShrinkingTime, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial struct CircleStateUnion {
    ...
    [FieldOffset(8)]
    [FieldOverlap(8)]
    [FramePrinter.PrintIf("_field_used_", Quantum.CircleStateUnion.COOLDWONSTATE)]
    private CooldwonState _CooldwonState;
    public const Int32 INITIALSTATE = 1;
    public const Int32 PRESHRINKSTATE = 2;
    public const Int32 SHRINKSTATE = 3;
    public const Int32 COOLDWONSTATE = 4;
    public Int32 Field {
      get {
        return _field_used_;
      }
    ...
    public CooldwonState* CooldwonState {
      get {
        fixed (CooldwonState* p = &_CooldwonState) {
          if (_field_used_ != COOLDWONSTATE) {
            Native.Utils.Clear(p, 4);
            _field_used_ = COOLDWONSTATE;
          }
          return p;
        }
      }
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + _CooldwonState.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        if (p->_field_used_ == COOLDWONSTATE) {
          Quantum.CooldwonState.Serialize(&p->_CooldwonState, serializer);
        }
  ...
  public unsafe partial struct CharacterStats : Quantum.IComponent {
    ...
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    public AssetRef<CharacterStatsConfig> CharacterStatConfig;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 18671;
        hash = hash * 31 + CharacterStatConfig.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (CharacterStats*)ptr;
        AssetRef.Serialize(&p->CharacterStatConfig, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.CooldwonState), Quantum.CooldwonState.SIZE);
