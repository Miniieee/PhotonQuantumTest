...
namespace Quantum.Prototypes {
  ...
  public unsafe partial class CharacterStatsPrototype : ComponentPrototype<Quantum.CharacterStats> {
    ...
    public void Materialize(Frame frame, ref Quantum.CharacterStats result, in PrototypeMaterializationContext context = default) {
        result.CharacterStatConfig = this.CharacterStatConfig;
  ...
  public unsafe partial class CircleStateUnionPrototype : UnionPrototype {
    ...
    public Quantum.Prototypes.CooldwonStatePrototype CooldwonState;
    ...
    public void Materialize(Frame frame, ref Quantum.CircleStateUnion result, in PrototypeMaterializationContext context = default) {
        switch (_field_used_) {
          ...
          case "COOLDWONSTATE": this.CooldwonState.Materialize(frame, ref *result.CooldwonState, in context); break;
  ...
  [System.SerializableAttribute()]
  [Quantum.Prototypes.Prototype(typeof(Quantum.CooldwonState))]
  public unsafe partial class CooldwonStatePrototype : StructPrototype {
    [HideInInspector()]
    public Int32 _empty_prototype_dummy_field_;
    partial void MaterializeUser(Frame frame, ref Quantum.CooldwonState result, in PrototypeMaterializationContext context);
    public void Materialize(Frame frame, ref Quantum.CooldwonState result, in PrototypeMaterializationContext context = default) {
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
  ...
  public unsafe partial class ShrinkStatePrototype : StructPrototype {
    ...
    public void Materialize(Frame frame, ref Quantum.ShrinkState result, in PrototypeMaterializationContext context = default) {
        result.ShrinkingTime = this.ShrinkingTime;
        MaterializeUser(frame, ref result, in context);
    }
  }
  [System.SerializableAttribute()]
